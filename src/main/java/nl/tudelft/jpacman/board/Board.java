...
public class Board {
     ...
     */
    private final Square[][] squares_board;
    ...
    public Square squareAt(int x, int y) {
        ...
        Square result = squares_board[x][y];
